...
DATASET_PATH="/media/car/harddisk/lafida/street_06/imgs/cam0"
#IMG_TS_PATH="/home/wangyh/DataSets/indoor_dynamic/images_and_timestamps.txt"
IMG_TS_PATH="/media/car/harddisk/lafida/street_06/cube_images_and_timestamps.txt"

#lafida indoor dynamic
../bin/cubemap_lafida ../Vocabulary/ORBvoc.txt \
    ../Config/mymonolafida1_cam0_params.yaml \
    "$DATASET_PATH" \
    "$IMG_TS_PATH" \
    "$CUBE_MASK" \
    ../bin/paper/street_06.txt \
    ../bin/paper/street_06_perf.txt
